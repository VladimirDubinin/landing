        ...
        <div class="bio-wrapper">
            <div class="description">
                <p class="text-mobile">
                    ...
                    коммерческой разработки веб-приложений <?= $stage ?> на языках программирования PHP и JS.
                </p>
                <p class="text-mobile">
                ...
                <p class="text-mobile m-0">
                    ...
                    Также использую в работе такие инструменты, как Docker, GitHub, СУБД MySQL и PostgreSQL,
                    нереляционную СУБД Redis.
                </p>
            </div>
